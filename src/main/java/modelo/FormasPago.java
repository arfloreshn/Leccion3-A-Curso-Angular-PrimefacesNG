...
@NamedQueries({
    ...
    , @NamedQuery(name = "FormasPago.findByIdformapago", query = "SELECT f FROM FormasPago f WHERE f.idformapago = :idformapago")
...
public class FormasPago implements Serializable {
    ...
    public FormasPago(Short idformapago) {
    ...
    public String toString() {
        return "modelo.FormasPago[ idformapago=" + idformapago + " ]";
    }
